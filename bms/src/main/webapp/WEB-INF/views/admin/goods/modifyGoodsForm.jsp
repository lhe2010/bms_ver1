...
<DIV class="clear"></DIV>
	...
	<DIV id="container">
		...
		<DIV class="tab_container">
			...
			<tr>
				<td>상품출판일</td>
				<td><input name="goods_published_date"  type="date"  value="${goods.goods_published_date }" /></td>
			...
			<tr>
				<td>상품 도착 예정일</td>
				<td><input name="goods_delivery_date" type="date"  value="${goods.goods_delivery_date }" /></td>
