...
<script src="http://dmaps.daum.net/map_js_init/postcode.v2.js"></script>
	    ...
	    function execDaumPostcode() {
	    	...
	    	new daum.Postcode({
	            oncomplete: function(data) {
	                ...
	                $("#roadAddress").val()  = data.fullRoadAddr;
	                ...
	                if (data.autoRoadAddress) {
	                    ...
	                    $("guide").val() = '(예상 도로명 주소 : ' + expRoadAddr + ')';
	                    //document.getElementById('guide').innerHTML = '(예상 도로명 주소 : ' + expRoadAddr + ')';
	
	                } 
	                else if (data.autoJibunAddress) {
	                    var expJibunAddr = data.autoJibunAddress;
	                    $("guide").val() = '(예상 지번 주소 : ' + expJibunAddr + ')';
	...
	function fn_modify_member_info(member_id,mod_type){
		...
		$.ajax({
			...
			url : "http://localhost:8080/bms/admin/member/modifyMemberInfo.do",
			data : {
				member_id:member_id,
				mod_type:mod_type,
				value:value
	...
	function fn_delete_member(member_id ,del_yn) {
	    ...
	    frm_mod_member.action="/bms/admin/member/deleteMember.do";
		...
		<table>
			<tbody>
				...
				<tr class="dot_line">
					...
					<td>
				   	  <input type="radio" name="member_gender" value="101" <c:if test="${member_info.member_gender eq '101' }">checked </c:if> />남성&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				      <input type="radio" name="member_gender" value="102" <c:if test="${member_info.member_gender eq '101' }">checked </c:if> />여성
					</td>
					<td>
