...
<script>
	...
	function search_member(search_period){	
		...
		i_fixedSearchPeriod.type  = "hidden";
	    ...
	    formObj.method="get";
	    formObj.action="/bms/admin/member/adminMemberMain.do";
	    formObj.submit();
	...
	function calcPeriod(search_period){
		...
		if (search_period == 'today'){
			...
			if (endDay-7<1)	beginMonth=dt.getMonth();	
			else			beginMonth=dt.getMonth()+1;
			...
			beginYear = dt.getFullYear();
			if (endDay-14<1) beginMonth=dt.getMonth();	
			else			 beginMonth=dt.getMonth()+1;
	...
	function fn_member_detail(order_id){
	    ...
	    formObj.method = "post";
	    formObj.action = "/bms/admin/member/memberDetail.do";
	    formObj.submit();
	...
	function fn_detail_search(){
		...
		i_fixedSearchPeriod.value = null;
